...
func TestFuzzyConversion(t *testing.T) {
	t.Run("for KubeadmConfig", utilconversiontest.FuzzTestFunc(utilconversiontest.FuzzTestFuncInput{
		Hub:         &bootstrapv1.KubeadmConfig{},
		Spoke:       &KubeadmConfig{},
		FuzzerFuncs: []fuzzer.FuzzerFuncs{fuzzFuncs},
	}))
	t.Run("for KubeadmConfigTemplate", utilconversiontest.FuzzTestFunc(utilconversiontest.FuzzTestFuncInput{
